    ...
    <div class="h-full w-full flex flex-col items-center justify-center">
      ...
      <div class="mt-10">
        <p class="text-sm text-base-content/60 font-medium">
          Ready to go?
          <RouterLink to="/login" class="link link-primary link-hover font-semibold ml-1"
            >Access your wallets</RouterLink
          >
        </p>
      </div>
    </div>
...
const { form, onFormSubmit, serverError, isPending, formErrors } = useRegisterForm()
</script>
